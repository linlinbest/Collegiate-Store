//preload the images
function preload(arr_images) {
  var newimages = [];
  for (var i = 0; i < arr_images.length; i++) {
    newimages[i] = new Image();
    newimages[i].src = arr_images[i];
  }
}
var imgs = ['../Data/002.jpg', '../Data/003.jpg', '../Data/010.jpg', '../Data/100.jpg', '../Data/020.jpg', '../Data/030.jpg', '../Data/200.jpg', '../Data/300.jpg'];
preload(imgs);
